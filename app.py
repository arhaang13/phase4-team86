...
def add_airplane():
    if request.method == 'POST':
        ...
        # Correctly handle maintained
        maintained_raw = request.form.get('maintained')
        if maintained_raw == 'TRUE':
            maintained = 1
        elif maintained_raw == 'FALSE':
            maintained = 0
        else:
            maintained = None
...
# Correctly handle neo
        neo_raw = request.form.get('neo')
        if neo_raw == 'TRUE':
            neo = 1
        elif neo_raw == 'FALSE':
            neo = 0
